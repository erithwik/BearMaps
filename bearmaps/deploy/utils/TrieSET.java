/**
 * @source: This is from https://algs4.cs.princeton.edu/52trie/TrieSET.java.html which I slightly changed to suit the timing
 * requirements for the project. I also got this idea from a Piazza post.
 */
...
public class TrieSET implements Iterable<String> {
    ...
    private static class Node {
        private Node[] next = new Node[123];
